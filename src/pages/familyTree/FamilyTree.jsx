...
var initialNodes = [
  { id: "1", sourcePosition: 'bottom' ,
  position: { x: 0, y: 0 }, data: { id:"1",label: "Husband" },type:'custom' },
...
function recData(value, x, y,edge,index){
    let node = {};
    node.id = value.id;
    node.type = 'custom';
    node.data = value;
